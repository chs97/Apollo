...
import { Tabs, SearchBar, Modal, List, Button, Toast } from 'antd-mobile'
  ...
  render() {
    ...
    return (
      <div className="list">
        {this.search ? (
          <div>
            <SearchBar onCancel={() => (this.search = false)} placeholder="输入学号" ref={ref => (this.manualFocusInst = ref)} />
            <div className="search-list" onClick={() => (this.addModal = true)}>
